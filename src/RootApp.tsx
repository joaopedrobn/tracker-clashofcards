...
export default function RootApp() {
  ...
  const tracker = useSyncedCollection(auth.user?.id ?? null, Boolean(profileState.profile), profileState.profile?.displayName ?? "");
  ...
  return <div className="min-h-screen">
    ...
    <Routes>
      <Route path="/" element={<CollectionPage tracker={tracker} transferOpen={transferOpen} setTransferOpen={setTransferOpen} />} />
      <Route path="/comunidade" element={<CommunityPage ownProfile={profileState.profile} myCollection={tracker.collection} />} />
      <Route path="/jogador/:id" element={<PublicPlayerPage mine={tracker.collection} myTag={profileState.profile?.clashPlayerTag} />} />
